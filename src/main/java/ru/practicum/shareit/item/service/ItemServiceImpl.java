...
public class ItemServiceImpl implements ItemService {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<ItemDtoOut> getByOwner(Long userId) {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<ItemDtoOut> getBySearch(String text) {
    ...
    @Override
    public CommentDtoOut createComment(Long itemId, CommentDtoIn commentDtoIn, Long userId) {
